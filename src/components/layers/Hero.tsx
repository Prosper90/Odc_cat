...
export default function Hero() {
  return (
    <div className="relative pt-[120px] max-md:pt-[110px] max-sm:pt-[120px] pb-10 bg-[#00070F] before:absolute before:inset-x-0 before:bottom-0 before:w-full before:h-[75px] before:z-[2] before:bg-gradient-to-t before:from-[#00070F] before:via-[rgba(0,7,15,0.33)] before:to-transparent before:content-['']">
      <img
        alt="bannerMain"
        loading="lazy"
        width="1600"
      ...
      <div className="container relative z-20">
        <div className="ml-auto max-w-[472px] flex flex-col max-[1200px]:max-w-none">
          <h1 className="leading-[1.1] text-5xl max-lg:text-[40px] max-md:text-[32px] font-inter font-semibold text-white animate-fade-in-up">
            The<span className="text-[#0FEDBE] animate-glow"> Best-Performing </span>Crypto
            SuperFund
          </h1>

          <p className="mt-[10px] text-white animate-fade-in-up animate-delay-200">
            Cat Finance enables users to unlock high-percentage yields
            through AI-driven DeFi funds, with USDT Dividends paid directly from
            performance
          </p>
          ...
          <ul className="mt-4 flex flex-col gap-4">
            <li className="flex items-start gap-3">
                ...
                >
                  ...
                  <defs>
                    ...
                    >
                      ...
                      <stop offset="1" stopColor="#42BDDD" />
                    </linearGradient>
              ...
              <p className="text-sm font-inter font-bold leading-[1.5] text-[#0FEDBE]">
          ...
          <div className="flex items-center gap-4 mt-5 max-sm:flex-col max-sm:[&>div]:w-full max-w-[408px]">
            ...
            <div className="relative">
              <button
                className="h-12 min-w-[166px] font-medium flex items-center cursor-pointer transition duration-300 ease-in-out justify-center gap-2.5 font-semibold max-sm:text-sm max-sm:h-10 max-sm:w-full bg-gradient-to-r from-cyan-300 to-emerald-300 rounded-[60px] text-[#00070F] hover:from-cyan-400 hover:to-emerald-400 px-5"
                aria-label="button"
              >
                How It Works?
              </button>
          ...
          <div className="bg-gradient-to-br from-[rgba(1,7,14,0.18)] to-[rgba(255,255,255,0.18)] border border-[rgba(97,97,97,0.5)] backdrop-blur-[15px] rounded-lg mt-5 max-w-[410px] max-[640px]:max-w-full">
            <div className="py-[19px] px-5 flex items-center gap-[15px] border-b border-[#616161] max-md:p-3 max-md:gap-2 max-[479px]:flex-col">
              <p className="text-base font-semibold font-inter min-w-[100px] text-[#0FEDBE]">
                Powered By:
              </p>
