...
export default function Whitepapers() {
  return (
    <div
      className="pt-[55px] max-[900px]:pt-[40px] whitePaperBG scroll-mt-[40px]"
      id="whitepaper"
    >
        ...
        <div className="flex gap-6 max-[1200px]:gap-5 justify-between max-[1200px]:flex-col-reverse max-[1200px]:items-center">
          ...
          >
            <img
              ...
              srcSet="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FwhitePaperImg.08de6334.png&w=640&q=75&dpl=dpl_EWAS8ZF1SPz1gvd3Hgrceu9TqG7t 1x, /_next/image?url=%2F_next%2Fstatic%2Fmedia%2FwhitePaperImg.08de6334.png&w=1080&q=75&dpl=dpl_EWAS8ZF1SPz1gvd3Hgrceu9TqG7t 2x"
              src="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2FwhitePaperImg.08de6334.png&w=1080&q=75&dpl=dpl_EWAS8ZF1SPz1gvd3Hgrceu9TqG7t"
            />
          </figure>
            ...
            <ul className="flex flex-col gap-6">
              ...
              >
                ...
                <div className="flex flex-col gap-[6px]">
                  ...
                  <p className="text-[14px]">
                    Diversified funds, including AI Fund, BTC Fund, Mining, and
                    RWA, each target specific growth opportunities.
                  </p>
                </div>
              </li>
              <li
